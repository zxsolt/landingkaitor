...
const services = [
  {
    ...
    accent: "rgba(2,201,120,0.12)",
    accentBorder: "rgba(2,201,120,0.2)",
    glowColor: "rgba(2,201,120,0.15)",
  },
  {
    number: "02",
  ...
  },
  {
    ...
    accent: "rgba(2,201,120,0.08)",
    accentBorder: "rgba(2,201,120,0.16)",
    glowColor: "rgba(2,201,120,0.12)",
  },
  {
    number: "05",
    label: "IA aplicada",
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          fontFamily: "var(--font-geist-mono)",
          lineHeight: 1,
          textShadow: "0 0 80px rgba(2,201,120,0.6)",
        }}
      ...
      <div className="relative z-10 p-7 md:p-8 flex flex-col h-full flex-1">
        ...
        {/* CTA */}
        <div className="mt-6 flex items-center gap-2.5 text-[#02c978] text-xs font-mono font-semibold opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
          <span
  ...
  return (
    <section id="servicios" className="relative py-28 md:py-36 px-6 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 50% at 50% 0%, rgba(2,201,120,0.04) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.div
            ...
            style={{
              minHeight: "260px",
              background: "linear-gradient(145deg, rgba(2,201,120,0.1) 0%, rgba(2,201,120,0.03) 50%, rgba(14,19,24,0.8) 100%)",
              border: "1px solid rgba(2,201,120,0.25)",
            }}
            whileHover={{
              y: -5,
              boxShadow: "0 20px 60px rgba(2,201,120,0.15)",
              transition: { duration: 0.3 },
            }}
          >
            {/* Top-right burst */}
            <div
              ...
              style={{
                background: "radial-gradient(circle at top right, rgba(2,201,120,0.25) 0%, transparent 60%)",
              }}
            />
            ...
            >
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                <path d="M8 56 L56 8 M34 8 H56 V30" stroke="#02c978" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            ...
            <Link
              href="#contacto"
              className="relative z-10 mt-8 inline-flex items-center gap-3 px-5 py-3 rounded-xl bg-[#02c978] text-[#080b0a] text-sm font-bold hover:bg-[#01a060] transition-colors duration-200 self-start"
